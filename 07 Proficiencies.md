...
|                   | Weapon            |                    |                          |              | Nonweapon         |              |
| ----------------- | ----------------- | ------------------ | ------------------------ | ------------ | ----------------- | ------------ |
| **Group  <br>**   | **Initial  <br>** | **# Levels  <br>** | **Non-Proficient  <br>** | **Familiar** | **Initial  <br>** | **# Levels** |
| Warrior           | 4                 | 3                  | -2                       | -1           | 3                 | 3            |
| Wizard            | 1                 | 6                  | -5                       | -3           | 4                 | 3            |
| Priest            | 2                 | 4                  | -3                       | -2           | 4                 | 3            |
| Rogue             | 2                 | 4                  | -3                       | -2           | 3                 | 4            |
...
| Style             | Warrior | Priest | Rogue | Wizard | Mystic |     |
| ----------------- | :-----: | :----: | :---: | :----: | :----: | --- |
| Unarmed           |    ✓    |   ✓    |   ✓   |   ✓    |   ✓    |     |
| Single Weapon     |    ✓    |   ✓    |   ✓   |   ✓    |   ✓    |     |
| Missile           |    ✓    |   ✓    |   ✓   |   ✓    |   ✓    |     |
...
Weapon proficiency slots may be spent to learn a single weapon, a tight weapon group, a broad weapon group, or other specific skills.
### Individual Weapons
...
Weapons are organized into **tight groups** and **broad groups**. All weapons belonging to a tight group are considered related to one another.

A character may spend two weapon proficiency slots to gain proficiency with every weapon in a tight group.

Broad groups include one or more tight groups and may also include weapons that are not part of a tight group (indicated as 'unrelated'). A character may spend three weapon proficiency slots to gain proficiency with every weapon in a broad group. A broad group may contain weapons that do not belong to a tight group.
#### Close Blades
...
**Off-Hand Blades:** Main-Gauche, Jitte, Sai, Parrying Dagger
#### Brawling Weapons
...
#### Military Bludgeons
One-handed battlefield impact weapons designed for armor penetration and battlefield durability rather than improvisation or dueling.
...
#### Hewing Weapons
Heavy chopping weapons designed to break shields, armor, or formation cohesion through momentum-driven cuts.
...
#### Hooking Polearms
Polearms designed to control opponents through hooking, trapping, armor penetration, or destabilizing strikes.

**Control Hooks:** Bill, Bill-Guisarme, Hook Fauchard, Military Fork
**Armor Penetrators:** Partisan, Spetum, Ranseur, Fork
...
**Throwing Knives:** Throwing Knife, Dagger, Knife, Stiletto
...
#### No Broad Group
The following are additional tight groups that do not belong to a broad group

**Agricultural Implements:** Grain Flail, Kama, Pry Bar, Scythe, Sickle, Spade
**Lances:** Light Lance, Medium Lance, Heavy Lance, Jousting Lance
**Entangling Weapons:** Net, Bolas, Lasso, Grapple

### Barred Weapons
A character may purchase any weapon group that contains a weapon available to his class, however any weapons within that group that are *barred* to the character (by class, kit, faith, etc.) may not be used.

### Unique Weapons
Some weapons are sufficiently unusual that they belong to no weapon group. These weapons must be learned individually and grant familiarity with no other weapons.

Examples include boomerangs, mancatchers, and whips.

### Familiarity
A character proficient with a **single weapon** is automatically familiar with all other weapons that share a tight group with that weapon.
...
A weapon group proficiency counts as the first proficiency slot invested in *one* weapon from that group for the purposes of Expertise, Specialization, Mastery, High Mastery, and Grand Mastery.

For example, a (non-warrior) character with proficiency in the Axes tight group may spend one additional weapon proficiency slot to gain Expertise with a battle axe, or a warrior could spend one additional slot to gain Specialization with that weapon. 

Example: A fighter with proficiency in the Axes group spends one additional slot to specialize in the battle axe. If he later wishes to specialize in the hand axe as well, he must spend two additional slots, since the group proficiency has already been applied to the battle axe.
...
### Expertise
For characters that do not have the ability to take weapon specialization, expertise represent the pinnacle of their training with a weapon. Warriors may become experts in a weapon they are proficient in, and may gain expertise in a second weapon once they attain 5th level; Non-warriors may only become experts in one weapon and only once they attain 5th level. An expert gains the same extra attacks as a specialist (see next paragraph) and may use any unusual weapon properties that are normally reserved for specialists. Expertise costs one weapon proficiency slot per weapon.
...
|Category|Benefits of Specialization|
|-|-|
...
Each proficiency requires a specific number of these slots to initially acquire, and slots may also be used to *improve* an existing skill with each additional slot allocated towards a proficiency increasing the character's base modifier in that skill by 1 per additional slot invested. Some skills may also be taken multiple times for different purposes, for example modern languages might be taken once to speak Elven and again to speak Orcish.
...
**Nonweapon Proficiency Slots from Class**

| Group   | Initial Slots | 1 additional slot at levels divisible by... |
| ------- | ------------- | ------------------------------------------- |
| Warrior | 3             | 3                                           |
| Wizard  | 4             | 3                                           |
| Priest  | 4             | 3                                           |
