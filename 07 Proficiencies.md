# Chapter 7: Proficiencies

Most of what a player character can do is defined by his race, class, and ability scores however these three characteristics don't cover everything. Characters can have a wide range of talents, from the potent (and intricate) arts of magic to the simple and mundane knowledge of how to build a good fire. A character's magical ability (or lack thereof) is defined by his class. Lesser abilities, such as fire building, are defined by proficiencies.
...
Even newly created 1st-level characters begin with proficiencies. The number of starting slots is determined by his class group, as shown in the Proficiency Slots Table Each proficiency slot is empty until the player "fills" it by selecting a proficiency. The character's Intelligence score modifies the number of slots he has, granting him more proficiencies (see the Intelligence Table). In both cases, new proficiencies are learned the same way.

As an example we have a thief with an intelligence score of 11. As part of the Rogue Class Group he begins with two weapon proficiency slots and three nonweapon proficiency slots; his Intelligence of 11 gives him two additional proficiency slots which he may use as either weapon or non-weapon.

Slots represent what has already been learned, not what might be learned in future. As such, they must be spent when earned or they are lost. Characters may not save or 'pool' slots to decide on how to use later, however they _can_ assign slots towards things they cannot yet use (representing learning that has begun but is not yet complete). For example, if a proficiency costs 2 slots, it could be assigned 1 slot to it at level 1 and assigned another when a slot is gained at level 3. If a proficiency has prerequisites (for example Weapon Mastery requires level 5) the character only needs to meet the requisite to benefit from the skill, not to assign slots towards it (so a player could assign weapon mastery to a slot at level 3 and have the benefit as soon as they reach level 5).

Thereafter, as the character advances in experience levels, he gains additional proficiency slots. The rate at which he gains them depends on the group he belongs to. The Proficiency Slots Table also lists how many levels the character must gain before he earns another slot.

**Initial Weapon Proficiencies** is the number of weapon proficiency slots received by characters of that group at 1st level.

**# Levels** (for both weapon and nonweapon proficiencies) tells how quickly a character gains additional proficiency slots. A new proficiency slot is gained at every experience level that is evenly divisible by the number listed. A warrior, for example, gains one weapon proficiency slot and one non-weapon proficiency at every level evenly divisible by 3. He thus gets the new slots at 3rd level, 6th, 9th, and so on.

**Penalty** is the modifier to the character's attack rolls when he fights using a weapon he is **not** proficient with.

**Initial Nonweapon Proficiencies** is the number of nonweapon proficiency slots that character has at 1st level.

**Table 29: Proficiency Slots Table**

| **Group**         | **Initial** | **# Levels** | **Non-Proficient** | **Familiar** | **Initial** | **# Levels** |
| ----------------- | ----------- | ------------ | ------------------ | ------------ | ----------- | ------------ |
| Warrior           | 4           | 3            | -2                 | -1           | 3           | 3            |
| Priest            | 2           | 4            | -3                 | -2           | 4           | 3            |
| Wizard            | 1           | 6            | -5                 | -3           | 4           | 3            |
...
Among other things, he is studying and practising whatever new proficiencies he will eventually learn. Using this "down time" to handle the less exciting aspects of a role-playing campaign lets players concentrate on more important (or more interesting) matters.

Most skills are easier to learn if someone teaches the character. A teacher may be another player character or an NPC, but in either case they must be more skilled than the character being taught. For some skills or skill levels, locating a teacher of sufficient ability, or persuading one to provide instruction, may be an adventure unto itself. Furthermore, most teachers expect payment. While an arrangement might be reached whereby the student renders service or barters goods in exchange for training, in most cases the payment is monetary. The cost of training is determined by the DM, taking into account the nature and rarity of the skill, the level of instruction to be provided, and (for NPCs) the motivations of the instructor.

The DM may instead decide that formal instruction is unnecessary for a particular proficiency or level of training. Many people develop competence through repeated practice and experience alone. The DM may still assign an appropriate cost for books, tools, or other learning materials. A proficiency learned without instruction does not grant automatic success for routine tasks until the character has gained sufficient practical experience with the skill, as determined by the DM. Until then, proficiency checks may be required even in circumstances that would otherwise succeed automatically.

## Fighting Styles

A fighting style represents training in a particular method of combat. While weapon proficiencies measure skill with specific weapons, fighting styles determine how a character employs those weapons in battle. A character may know several fighting styles and freely choose which one he is using at the beginning of each round.

Characters begin play knowing certain fighting styles based on their class group, as shown below. Additional styles may be learned by spending one weapon proficiency slot. Attempting to fight in an unfamiliar style imposes a -1 penalty to attacks, and +1 penalty to AC.

**Table 30: Fighting Styles**

| Style             | Warrior | Priest | Wizard | Rogue | Adept |
| ----------------- | ------- | ------ | ------ | ----- | ----- |
| Unarmed           | ✓       | ✓      | ✓      | ✓     | ✓     |
| Single Weapon     | ✓       | ✓      | ✓      | ✓     | ✓     |
| Missile           | ✓       | ✓      | ✓      | ✓     | ✓     |
...
All characters may attempt special combat manoeuvres, as described in the combat chapter, regardless of fighting style known.

Characters may specialize in fighting styles by spending additional weapon proficiency slots. Warriors may specialize in any number of fighting styles. Priests, rogues, and mystics may specialize in one fighting style. Wizards may not specialize in fighting styles.

Unless otherwise stated, a character may only specialize once in a fighting style.

### Single Weapon Style

The character fights with a single one-handed weapon and keeps his off-hand empty. The free hand may be used to manipulate objects, cast spells requiring only one free hand, or make unarmed attacks.

If the character makes an off-hand attack, such as a punch, grab, or similar action, he is treated as fighting with two weapons and suffers the normal penalties for Two-Weapon Style.

**Specialization:** The character gains a +1 bonus to Armour Class while fighting in this style. A second weapon proficiency slot may be spent to increase this bonus to +2; this is the maximum benefit obtainable from Single Weapon Style specialization.

### Two-Handed Weapon Style

The character fights with a weapon requiring two hands to use, or with a one-handed weapon wielded in both hands. This includes weapons with separate one- and two-handed statistics, such as spears, as well as weapons normally used in one hand but capable of being gripped with both.

**Specialization:** Weapons used in this style reduce the weapon's speed factor by 3 to a minimum of 0.

In addition, the character gains a +1 bonus to damage rolls when wielding a normally one-handed weapon in two hands.

### Weapon and Shield Style

The character fights with a one-handed weapon and shield. A character using this style may perform shield attacks, shield rushes, and use a shield for blocks and traps as described in the Combat chapter.

**Specialization:** The character may make one shield attack, shield rush, block, or trap each round without losing the shield's Armour Class bonus for that round.

### Two-Weapon Style

The character fights with a weapon in each hand.

The primary weapon may be any one-handed weapon. The secondary weapon must be at least one size category smaller than the primary weapon. Daggers and knives may always be used as secondary weapons regardless of the size of the primary weapon.

The character suffers a –2 penalty to attacks with the primary weapon and a –4 penalty to attacks with the secondary weapon. These penalties are reduced by the character's Dexterity reaction adjustment, if any (penalty may be reduced to 0, but may never become a bonus).

The character gains one additional attack each round with the secondary weapon. This attack is separate from any additional attacks granted by level, specialization, mastery, or other abilities.

**Specialization:** The attack penalties are reduced to 0 with the primary weapon and –2 with the secondary weapon.

A second weapon proficiency slot may be spent to allow the use of two weapons of equal size, provided both weapons may normally be used one-handed.

### Missile Style

The character fights primarily with missile and thrown weapons.

**Specialization:** The character may move up to half his normal movement rate and still attack with his full rate of fire, or move up to his full movement rate and attack at half his normal rate of fire.

In addition, the character gains a +1 bonus to Armour Class against enemy missile attacks while wielding a missile weapon.

When mounted, any penalties suffered for making missile attacks while riding are reduced by 2.

### Unarmed Style

The character fights using punches, kicks, wrestling holds, martial arts techniques, and other unarmed attacks.

**Specialization:** The character gains a +2 bonus to initiative when making unarmed attacks and a +1 bonus on all opposed rolls made as part of punching, wrestling, martial arts, or overbearing attacks.

### Regional Styles

The above fighting styles are the universal styles available to all characters. The DM may also develop unique regional styles involving one or two _specific weapons_. Such styles are available only to characters who originate from the appropriate culture or who seek out training in the style.

A character may specialize in a regional style by spending one weapon proficiency slot. The benefits of specialization are determined by the DM and are cumulative with those of the appropriate universal fighting style if the character is specialized in both.

Suggested specialization benefits include:

- –1 bonus to Armour Class
    
- +1 bonus to attack rolls
    
- +1 bonus to damage rolls
    
- the ability to perform one defensive manoeuvre each round without penalty (such as a block)
    
- one additional unarmed attack each round
    
- negation of a penalty that would normally apply
    
For example, a culture might be renowned for its mounted archers. Specialization in its regional style might negate the penalties for making missile attacks while mounted and using a composite short bow . A character also specialized in Missile Style would still gain that style's +1 bonus to Armour Class, while the reduction of penalties for firing while riding would continue to apply whenever using missile weapons other than a composite short bow.

## Weapon Proficiencies

Weapon proficiencies represent formal training with specific weapons or groups of related weapons. A character proficient with a weapon knows how to employ it effectively in combat and may use any special attacks or techniques described in its entry.

Weapon proficiency slots may be spent to learn a single weapon, a family or class of weapons, or other specific skills.

### Nonproficiency

A character may attempt to use any weapon, even one with which he has no training.

When using a nonproficient weapon, the character suffers the Nonproficiency penalty shown on the Proficiency Slots Table. This penalty applies to both attack rolls and initiative.

For missile weapons, the weapon's rate of fire is halved (round fractions down, minimum 1 attack per round).

In addition, a nonproficient character may not use any special attacks, manoeuvres, or techniques described in the weapon's entry.

### Individual Weapon Proficiency

The most common use of a weapon proficiency slot is to gain proficiency with a single weapon. Unless otherwise noted, proficiency with a weapon costs one weapon proficiency slot.

A character proficient with a weapon may use it without penalty and gains access to any special attacks or abilities described in the weapon's entry.

#### Familiarity

A character proficient with a **single weapon** is automatically _familiar_ with all other weapons that belong to the same family of weapons.

A familiar weapon is not used as effectively as a proficient weapon, but the character's previous training reduces the penalties normally associated with nonproficiency.

When using a familiar weapon, the character suffers the Familiarity penalty shown on the Proficiency Slots Table. This penalty applies only to attack rolls.

Familiarity does not penalize initiative, rate of fire, or any other weapon characteristics. However, a character using a familiar weapon may not employ any special attacks or techniques described in the weapon's entry.

### Weapon Group Proficiency

Many weapons are similar in construction and method of use. Rather than learning each individually, a character may learn an entire group of related weapons.

Weapons are organized into **weapon classes** and **weapon families**. All weapons belonging to a weapon family are considered related to one another.

A character may spend two weapon proficiency slots to gain proficiency with every weapon in a weapon family.

Weapon classes include one or more families and may also include weapons that are not part of a family (indicated as 'unrelated'). A character may spend three weapon proficiency slots to gain proficiency with every weapon in a weapon class.

#### Weapon Groups and Barred Weapons

A character may purchase any weapon group that contains a weapon available to his class, however any weapons within that group that are _barred_ to the character (by class, kit, faith, etc.) may not be used.

### Weapon Group Descriptions

#### Close Blades

Short, agile weapons intended for fighting at arm’s length or less. This group includes weapons used as sidearms, in confined spaces, or during grappling and close-quarter combat.

**Daggers & Knives:** Dagger, Dirk, Knife, Jambiya

**Fist Blades:** Katar, Bagh Nakh, Glove Nail, Elbow Spike, Knee Spike

**Dueling** **Blades:** Estoc, Main-Gauche, Jitte, Rapier, Sai, Parrying Dagger

#### Brawling Weapons

Compact impact weapons intended for improvised or brutal close combat. These rely on leverage, striking surfaces, or reinforced grips rather than formal weapon technique.

**Clubs:** Club, Belaying Pin, Sap, Large Holy Symbol

**Reinforced Strikers:** Cestus, Gunsen, Kau Sin Ke

#### Martial Blades

One-handed battlefield weapons designed for sustained combat. They balance reach, speed, and adaptability, and are suitable for formation or individual fighting.

**Short Swords:** Gladius, Short Sword, Wakizashi, Sapara

**Arming Swords:** Long Sword, Broad Sword, Spatha, Bastard Sword

**Curved Swords:** Sabre, Scimitar, Tulwar, Cutlass

**Heavy Sidearms:** Falchion, Khopesh, Machete/Parang, Drusus

#### Military Bludgeons

One-handed battlefield impact weapons designed for armour penetration and battlefield durability rather than improvisation or dueling.

**Maces:** Footman's Mace, Morningstar, Horseman's Mace, Mace-Axe

**War Hammers & Picks:** Warhammer, Footman's Pick, Horseman's Pick, Military Pick

#### Great Blades

Cutting weapons, typically two-handed, that rely on leverage, reach, and committed strikes to overwhelm opponents through blade geometry and momentum.

**Great Swords:** Claymore, Great Sword, Two-Handed Sword,

**Not Related:** No-Dachi, Katana

#### Heavy Weapons

Large two-handed impact weapons that rely on mass and momentum rather than precision or cutting technique.

**Great Hammers:** Maul, Sledge Hammer, Great Club

**Heavy Flails:** Footman's Flail, Tetsubo

#### Hewing Weapons

Heavy chopping weapons designed to break shields, armour, or formation cohesion through momentum-driven cuts.

**Battle Axes:** Battle Axe, Stone Axe, Two-Handed Axe

**Pole Axes:** Bardiche, Voulge, Sword-Axe

**Chopping Blades:** Scythe, Ritiik, Iuak

#### Spears

Thrusting weapons used to control distance and maintain reach advantage in both individual and formation combat.

**Throwing Spears:** Harpoon, Javelin, Pilum, Spear, Trident

**Formation Spears:** Long Spear, Pike, Awl Pike, Brandistock

#### Blade Polearms

Pole-mounted weapons whose primary function is cutting or slashing. They extend blade techniques into reach combat.

**Glaives:** Glaive, Fauchard, Naginata, Nagimaki

**Heavy Blade Polearms:** Guisarme, Glaive-Guisarme, Guisarme-Voulge, Lajatan

#### Hooking Polearms

Polearms designed to control opponents through hooking, trapping, armour penetration, or destabilizing strikes.

**Control Hooks:** Bill, Bill-Guisarme, Hook Fauchard, Military Fork

**A****rmour Penetrators:** Partisan, Spetum, Ranseur, Fork

**Crushing Polearms:** Halberd, Bec de Corbin, Lucern Hammer

#### Chain Weapons

Weapons using flexible linkage to generate unpredictable attack angles and momentum-based strikes.

**Weighted Chains:** Chain, Chijikiri, Kawanaga

**Linked Weapons:** Kusari-Gama, Nunchaku, Three-Piece Rod

#### Precision Throwing Weapons

Light missiles thrown primarily with wrist and forearm motion. They emphasize accuracy, speed, and repeatable use.

**Throwing Knives:** Dagger, Stiletto, Throwing Knife

**Throwing Discs:** Boomerang, Chakram, Shuriken

**Not Related:** Darts

#### Hurled Weapons

Heavier missiles thrown using full-body motion. These emphasize force, range, and battlefield impact.

**Throwing Axes and Hammers:** Hammer, Hand Axe, Hatchet, Warhammer

**Hurled Spears:** Javelin, Pilum, Spear, Trident, Harpoon

#### Bows

Self-propelled missile weapons using flexible staves to store and release energy.

**Traditional Bows:** Short Bow, Long Bow, Composite Short Bow, Composite Long Bow

**Unrelated:** Daikyu, Folding Bow

#### Crossbows

Mechanical missile weapons that store and release energy independently of the user.

**Simple Crossbows:** Light Crossbow, Hand Crossbow, Pellet Bow

**Unrelated:** Cho-Ku-No, Heavy Crossbow,

#### Independent Weapon Families

The following weapon families do not belong to a broader weapon class.

**Peasant Weapons****:** Grain Flail, Kama, Pry Bar, Scythe, Sickle, Spade

**Lances:** Light Lance, Medium Lance, Heavy Lance, Jousting Lance

**Entangling Weapons:** Net, Bolas, Lasso, Grapple

### Unique Weapons

Some weapons are sufficiently unusual that they belong to no weapon class or family. These weapons must be learned individually and grant familiarity with no other weapons.

Examples include mancatchers, whips, and other weapons whose method of use does not closely correspond to any other existing weapons.

### Weapon Groups and Advanced Training

For the purposes of developing expertise or specialization in a weapon, a weapon group proficiency is counted as proficiency for _one_ chosen weapon from that group. If a fighter wishes to specialize in an additional weapon from the same group they must spend an additional slot to gain specialization

For example, a fighter that chose proficiency in the military blades weapon class may choose to specialize in the Broad Sword for the ordinary cost, but if they later choose to become specialized with the Short Sword, they must expend an additional slot.

## Improving Weapon Proficiencies

Basic proficiency in a weapon represents competence. Characters wishing to devote additional training to a particular weapon may pursue advanced training. Single-Class Fighters (and others explicitly allowed by other rules) may pursue specialization in specific weapons, possibly progressing to Mastery, High Mastery, and even Grand Mastery of that weapon. Characters not entitled to specialize in a weapon may instead gain expertise. Expertise and specialization are mutually exclusive, a character may have one or the other, not both.

### Expertise

For characters that do not have the ability to take weapon specialization, expertise represent the pinnacle of their training with a weapon. Warriors may become experts in a weapon they are proficient in, and may gain expertise in a second weapon once they attain 5th level; Non-warriors may only become experts in one weapon they are proficient with and only once they attain 5th level. An expert gains the same extra attacks as a specialist (see next paragraph) and may use any unusual weapon properties that are normally reserved for specialists. Expertise costs one weapon proficiency slot.

### Specialization

A single-class fighter (or other character when permitted) may become a specialist in a weapon they are proficient in, and may choose to specialize in an additional weapon once they have attained 5th level. The benefits of specialization vary with the type of weapon and how it is used, but all specialists gain extra attacks, and also may use any unusual weapon properties in the weapon description that are reserved for specialists. Specializing in any bow or crossbow costs 2 weapon proficiency slots, all other weapons cost 1 slot.

Benefits of Specialization:  

**All Weapons:** 1 extra attack every 2nd round  

**Melee attacks**: +1 to hit, +2 Damage  

**Bows:** +1 to hit at any range and +2 damage at point blank range (30 feet or less)  

**Crossbows:** +1 to hit at any range and +2 damage at point blank range (60 feet or less)  

**Other missile weapons or weapons used as missiles:** +1 to hit at any range

### Weapon Mastery

Weapon mastery represents exceptional dedication to a single weapon. Through extensive training and practice, single-classed fighters may develop abilities beyond specialization, and attain Mastery, High Mastery, or even Grand Mastery of a single chosen weapon.

To pursue mastery, a character must first be specialized in a weapon. After attaining mastery a fighter may continue to invest weapon proficiency slots in the same weapon towards High Mastery and Grand Mastery. Proficiency slots may be committed before the required level is attained, but the benefits of Mastery, High Mastery, and Grand Mastery are not gained until 5th, 9th, and 13th level, respectively.

Mastery applies only to a single weapon, not to a weapon group, and confers no additional benefits with other weapons, even if they are extremely similar.

The effects of Mastery, High Mastery, and Grand Mastery are described in the sections that follow.

#### Mastery

A fighter who attains Mastery with a weapon improves the benefits gained from specialization.

For melee weapons, the attack and damage bonuses granted by specialization increase to **+3 attack** and **+3 damage**.

For bows and crossbows, the point-blank attack and damage bonuses increase to **+3 attack** and **+3 damage**. At short, medium, and long range, the weapon gains an additional **+1 attack bonus**, increasing the master's total attack bonus to **+2** at those ranges.

#### High Mastery

A fighter who invests a second mastery slot in a weapon attains High Mastery.

When using the mastered weapon, the fighter gains a **+1 bonus to initiative**.

A High Master scores a critical hit on a natural roll of **16 or higher** that exceeds the required attack roll by **5 or more**.

A High Master using a bow, crossbow, or sling gains an additional **Extreme Range** category equal to **150% of the weapon's Long Range**. Attacks at Extreme Range suffer a **–10 penalty** before other modifiers are applied.

#### Grand Mastery

A fighter who invests a third mastery slot in a weapon attains Grand Mastery.

The fighter gains **+1 attack per round** when using the mastered weapon. This bonus is included in the Multiple Attacks and Rates of Fire table.

In addition, the weapon's damage dice increase by one die step. If a weapon inflicts multiple damage dice, each die is increased separately.
...
## Shield and Armour Specialization

Characters may devote additional training to the use of their defensive equipment. A character proficient in **Weapon and Shield Style** may specialize in one specific size of shield. Any character may specialize in one specific type of armour permitted by his class. Each specialization costs **one weapon proficiency slot** and applies only to the chosen shield size or armour type.

### Shield Specialization

A character specialized in a shield gains the following benefits while using the chosen shield:

| Shield Size   | Normal Protection                       | Specialized Protection                  |
| ------------- | --------------------------------------- | --------------------------------------- |
| Buckler       | +1 AC against one attack each round     | +1 AC against one attacker each round   |
| Small Shield  | +1 AC against two attacks each round    | +2 AC against three attacks each round  |
| Medium Shield | +1 AC                                   | +2 AC                                   |
| Tower Shield  | +1 AC, or +2 AC against missile attacks | +2 AC, or +3 AC against missile attacks |

### Armour Specialization

A character specialized in a type of armour gains the following benefits while wearing the chosen armour:

- The time required to don or remove the armour is reduced by **1** (minimum **1**).
    
- Hastily donned armour provides its full Armour Class. Any penalties to attack rolls or other actions from improperly adjusted armour still apply until it has been correctly fitted.
    
- Only **half** the armour's weight counts for encumbrance, if encumbrance rules are being used.

## Combat Talents

Weapon proficiency slots may also be spent to acquire specialized combat talents. These represent additional abilities, behaviours, and instincts the character has developed in training to fight, or gained through battlefield experience.

Some combat talents are also non-weapon proficiencies and may be acquired with either weapon or non-weapon proficiency slots. These are detailed in the next part of this chapter: 'Alertness, Blind-Fighting, Camouflage, Endurance.'

The remaining special talents listed below may only be purchased with Weapon Proficiency Slots.

Except for being purchased with weapon proficiency slots, they follow the same rules as non-weapon proficiencies.

**Table 31: Combat Talents**

| Proficiency           | Proficiency Group(s)   | Slots | Ability | Modifier |
| --------------------- | ---------------------- | ----- | ------- | -------- |
| Ambidexterity         | Warrior, Rogue         | 1     | Dex     | 0        |
| Ambush                | Warrior, Rogue         | 1     | Int     | 0        |
| Battlefield Awareness | Warrior, Rogue, Priest | 2     | Wis     | -1       |
| Combat Reflexes       | Warrior, Rogue         | 2     | Dex     | 0        |
| Dirty Fighting        | Warrior, Rogue         | 1     | Int     | 0        |
| Fine Balance          | Warrior, Rogue         | 2     | Dex     | 0        |
| Iron WIll             | Warrior, Priest        | 2     | Wis     | -2       |
| Leadership            | Warrior                | 1     | Cha     | -1       |
| Quickeness            | Warrior, Rogue         | 2     | Dex     | 0        |
| Steady Hand           | Warrior, Rogue         | 1     | Dex     | 0        |
| Trouble Sense         | General                | 1     | Wis     | 0        |

#### Ambidexterity

The character is equally skilled with either hand. When fighting using Two-Weapon Style, the attack penalties become **–2** with both weapons. A character specialized in Two-Weapon Style suffers no attack penalty with either weapon.

#### Ambush

The character is skilled at selecting concealed positions, coordinating attacks, and exploiting terrain. When preparing an ambush, the DM may determine that favourable circumstances guarantee surprise. Where uncertainty exists, the character gains a **+4 bonus** on any proficiency or ability checks made to establish or maintain the ambush.

#### Battlefield Awareness

The character constantly observes the flow of battle and instinctively reacts to threats beyond his immediate attention. When attacked from the rear, the character retains any Dexterity bonus to Armour Class that would normally be lost. This proficiency provides no benefit against invisible attackers or creatures that have achieved surprise.

#### Combat Reflexes

The character possesses exceptional reflexes, allowing him to avoid exposing himself to enemy attacks. Each round, the first action or movement that would normally provoke an opportunity attack instead does not.

#### Dirty Fighting

The character is adept at exploiting distractions, feints, and other underhanded fighting techniques. The character gains a **+2 bonus** on opposed rolls made to perform combat manoeuvres that rely on deception, leverage, or surprise, including feints, disarms, shield traps, grapples, and similar actions at the DM's discretion.

#### Fine Balance

The character possesses exceptional balance and coordination. The character gains a **+2 bonus** on ability checks and saving throws made to avoid slipping, falling, or losing footing. Any penalties for fighting while off-balance or on unstable footing are reduced by **2**.

#### Iron Will

The character possesses exceptional mental discipline and determination. The character gains a **+1 bonus** on saving throws against charm, fear, suggestion, hypnosis, hold, and other mind-affecting magical effects.

In addition, while reduced below 0 hit points, the character may remain conscious by succeeding on a saving throw vs. Death each round, modified by his current negative hit point total. While conscious in this manner, the character neither falls unconscious nor continues to lose hit points until the saving throw is failed.

#### Leadership

The character understands how to organize, motivate, and direct others in battle. Troops, retainers, and other followers under the character's direct command receive a **+2 bonus** on Morale checks.

When using mass combat rules, the character is treated as **three levels higher** for determining command ability.

#### Quickness

The character possesses exceptional speed and coordination. The character gains a **+2 bonus to initiative** when attacking with a weapon whose Speed Factor is **5 or less**. This bonus does not apply while taking actions that require the character to remain stationary, such as guarding or similar defensive actions.

#### Steady Hand

The character possesses exceptional control when making missile attacks. If the character spends the round aiming before making a missile attack, the range category is reduced by one for that attack unless it is already the lowest category available to the character. The character may make only **one missile attack** that round, regardless of his normal rate of fire.

#### Trouble Sense

The character possesses an uncanny instinct for imminent danger. Whenever surprised, the character may immediately attempt a proficiency check. If successful, he may take **one defensive action** during the first segment of surprise. This may be movement of up to half his movement rate, a guard, block, shield block, or similar defensive action, but may not include an attack, spellcasting, or other offensive action.

## Nonweapon Proficiencies

A player character is more than a collection of combat modifiers. Most people have a variety of skills learned over the years. Consider yourself as an example--how many skills do you possess? You probably did over a decade of school, perhaps participated in extra-curricular activities, and maybe had some hobbies, through which you have probably picked up a number of skills (in addition to ones learned from family) beyond just those of your chosen career. The same is true of your player character; they can do more than just swing a sword, cast a spell, or pick a lock. To role-play the character well, you need an idea of _what else_ they are good at.

Nonweapon proficiencies are a way of handling the question of what skills and knowledge a character has beyond those of their class. Some of these skills, such as deciphering a document written in an ancient language, are things they can do that a person without proficiency would have effectively zero chance of succeeding at, others are things the proficient character can simply do better and/or in more challenging circumstances than others; anyone might eventually get a campfire burning in normal circumstances, but only a proficient character is likely to succeed in the middle of a torrential downpour.

Some proficiencies have obvious uses in encounters or while adventuring more broadly, others will likely require more creativity to apply during active play but could be relevant to the downtime between adventures (particularly when a character reaches a level where they control an estate, church, or guild).
...
Each proficiency requires a specific number of these slots to initially acquire, and slots may also be used to _improve_ an existing skill with each additional slot allocated towards a proficiency increasing the character's base modifier in that skill by 1 per additional slot invested. Some skills may also be taken multiple times for different purposes, for example modern languages might be taken once to speak Elven and again to speak Orcish.

In addition to 'buying' proficiencies with slots, a character may also receive bonus proficiencies from other sources such as their selection of race/subrace or character kit. DMs may also elect to award additional proficiencies for significant in-game experience - for example the entire party might be awarded proficiency in seamanship based on their actions in a naval-themed campaign (those that already possess the proficiency would instead get an increase to their base modifier).

At the DM’s discretion, characters may also gain or improve proficiencies through paid instruction. This typically involves locating a suitable teacher, convincing them to take the character on as a student, negotiating a fee, and committing downtime to training.

A teacher must have a higher base modifier in the proficiency than the student, and may require the student to demonstrate an aptitude for the skill (usually a minimum score in the relevant ability).

As a general guideline, learning a new proficiency requires 1d8+4 weeks of downtime, while improving an existing proficiency requires 1d4+2 weeks. Typical costs range from 10–50 gp per week, depending on the rarity of the skill and the quality of instruction.

### Nonweapon Proficiency Groups

Nonweapon proficiencies are organized into proficiency groups representing skills that can be learned by anyone (the general group) and skills that can be _more easily_ learned by specific groups of character classes. These groups are not restrictive - **i.e. any character may learn any proficiency (unless barred by a kit)** - _however_ acquiring a skill from a proficiency group that is not associated with a character's class will cost one more non-weapon proficiency slot than listed. Consult the table below to see which proficiency groups your character has access to based on their class:
...
A proficiency check is required only when dealing with obscure, fragmented, ancient, or highly specialized historical knowledge, or when attempting to interpret ambiguous or conflicting historical sources.

The character may select a particular era, culture, or subject of study (such as dwarven kingdoms, ancient empires, or the Age of Sorcerer-Kings). When working within this area of specialization, the DM may grant a bonus to checks or provide additional detail on success.
...
Animal Noise represents practised vocal mimicry and does not grant knowledge of animal behaviour. It may be combined with Animal Lore where understanding of behaviour, timing, or interpretation is required.
...
The armourer can repair damaged armour and identify construction flaws without requiring a proficiency check under normal circumstances.
...
In total darkness, the character suffers only a –2 penalty to attack rolls. Under starlight or moonlight, the character suffers only a –1 penalty. The character suffers no Armour Class penalties due to darkness or lack of visibility when defending against melee attacks.
...
This proficiency applies only to threats within immediate melee range. It provides no protection against missile attacks or effects originating beyond close combat distance, and armour Class penalties against such attacks remain unchanged.
...
A character with this proficiency is trained in the handling and operation of small watercraft such as kayaks, canoes, skiffs, and similar vessels intended for use on rivers, lakes, and near-shore waters. The character can reliably control such craft under normal conditions, including maintaining direction, speed, and basic manoeuvring without requiring a proficiency check. They are also capable of performing minor maintenance and field repairs, such as patching leaks, waterproofing seams, and making small structural adjustments sufficient to keep a vessel functional.
...
A proficiency check is required when conditions are unfavourable or when the concealment must withstand close, directed, or prolonged visual scrutiny, such as alert searchers, tracking creatures relying on sight, poor environmental cover, or time pressure.
...
The character has an intuitive sense of distance travelled and effort expended over time, allowing them to estimate how far they have moved during overland travel under normal conditions. In routine circumstances, the character can reliably approximate daily travel distance without requiring a proficiency check, provided travel conditions are not significantly misleading.
...
**Immediate Care** When a character tends to a wounded individual immediately after injury, they may attempt to stabilize the patient and restore a small amount of lost vitality. A proficiency check is always required.
...
**Ongoing Care** A wounded character under regular care from someone with this proficiency recovers more quickly than normal.
...
**Diagnosing and Treating Disease** A character may make a proficiency check to diagnose and treat non-magical diseases. Characters with Herbalism gain a +2 bonus to this check.
...
**Pole Vaulting** A character proficient in jumping may also use a suitable pole or similar implement to attempt extended vaulting manoeuvres over obstacles or gaps that would otherwise be impassable by normal jumping.
...
A character with this proficiency has undergone disciplined mental training designed to resist magical and mystical intrusion, including charm, fear, domination, illusion, and other effects that directly influence thought, perception, or emotion. The character gains a +1 bonus to saving throws against effects that directly target the mind or emotions, provided the effect normally allows a saving throw. This includes most charm and fear effects, mind-affecting spells, and psionic attacks that permit resistance through willpower or mental discipline.

This proficiency does not apply to effects that do not _directly_ influence the mind, such as physical transformations, purely sensory hazards, or environmental dangers, even if magical in origin.
...
A character with this proficiency is trained in the techniques of maritime navigation, including the use of stars, celestial positioning, ocean currents, wind patterns, and environmental signs to determine direction and avoid hazards. This proficiency applies in maritime or coastal environments where such methods are meaningful, and does not _normally_ apply to overland travel. In routine conditions, a proficient character can maintain a vessel’s general course, determine direction, and avoid becoming lost without requiring a proficiency check, provided adequate reference points (such as stars, coastline, or consistent conditions) are available.
...
A proficient rider may, when unarmoured, ride in a low or hanging position alongside the mount for protection. While doing so, the rider improves their effective Armour Class against attacks directed specifically at them by 6, but cannot attack, and any attack that would normally strike the rider instead strikes the mount.
...
_This proficiency is available to PCs but is typically more appropriate for NPCs_
...
A character with this proficiency may supervise quarrying or large-scale stonework operations; one trained mason can oversee up to five unskilled labourers.
...
The character can automatically avoid obvious environmental hazards and secure sufficient food and water for _their own_ subsistence in the normal conditions of their chosen terrain without a proficiency check. The character may also assist others using this knowledge, granting a +2 bonus to Survival checks made by _non-proficient_ characters attempting to use Survival in the same terrain.
...
In combat, a successful use of tumbling may improve armour Class against attacks directed solely at the character or grant a minor positional advantage; in unarmed combat, it may grant a bonus to attack rolls. The exact benefit depends on circumstances and is determined by the DM.
...
With a successful proficiency check, the character may work under adverse conditions, use poor-quality materials, or produce fine, dense, or specialized weaves (e.g., tightly woven cloth, decorative patterns, silk textiles, or materials suitable for upholstery or padded armour).

This proficiency governs the creation of cloth only; cutting, fitting, and finishing garments fall under Tailoring/Seamstress. High-quality weaves may grant bonuses to durability, value, or effectiveness at the DM’s discretion (e.g., improved wear resistance, suitability for armour padding).
